...
file_path = r'data\a_Eingangsdaten\Bedarf\Anwendungsbilanzen\EEV-GHDsektor nach Anwendungsbereichen 2023.xlsx'
...
# Titel und Layout
ax.set_title("EEV GHD nach Energieträgern und Anwendungen im Jahr 2023 in TWh", fontsize=14, pad=15, fontweight='bold', loc='center')
