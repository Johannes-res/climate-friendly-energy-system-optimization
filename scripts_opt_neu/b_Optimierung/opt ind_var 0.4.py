...
"""nötige Eingaben:
- df_bedarf: DataFrame der eine Zeitreihe beinhaltet mit dem Bedarf an Strom und Wärme (Später kommt noch Mobilität hinzu)
- df_erzeuger_strom: DataFrame der eine Zeitreihe beinhaltet mit den Verfügbarkeitsfaktoren der Erzeuger für Strom
- df_erzeuger_wärme: DataFrame der eine Zeitreihe beinhaltet mit den Verfügbarkeitsfaktoren der Erzeuger für Wärme
