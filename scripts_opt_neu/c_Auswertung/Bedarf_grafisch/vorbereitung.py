...
# Wechsle zum Projekt-Root (3 Ebenen nach oben vom Skript)
...
bedarf_gesamt['Strom_Gesamt_mit_Biomasse_und_Müll [MW]'] = bedarf_gesamt['Strom_Gesamt_Bedarf [MW]'] - bedarf_gesamt['Strom_Last [MW]'] + bedarf_gesamt['Strom_orginal_23 [MW]']
