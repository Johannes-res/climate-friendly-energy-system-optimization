...
def expand_daily_to_15min(df_daily, value_col='Warmwasserbedarf [GWh]'):
    """
...
df_15min = expand_daily_to_15min(df, value_col='Warmwasserbedarf [GWh]')
df_15min.to_excel(r'data\a_Eingangsdaten\Wärme\Warmwasserbedarf_15min_23.xlsx')
